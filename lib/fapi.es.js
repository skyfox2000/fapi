...
const kt = () => ht, Vt = (t) => {
  ...
  return e;
}, ft = /\$\{([\w\.\[\]0-9]+)\}/g, St = (t, e) => t.replace(ft, (r, u) => {
  var o;
  const a = u.split(".");
  let c = e;
  for (const s of a) {
...
class Lt {
  ...
  show(e) {
    const { title: r, icon: u, mask: a, duration: c, position: o } = e;
...
const z = new Lt(), M = (t) => {
  ...
  if (typeof a == "string")
    return a + r;
  if (typeof a == "object") {
    const { host: c, authorize: o } = a;
    return (u === void 0 || u === !1) && (t.authorize = o), r = c + r, r;
  }
  return r;
  ...
  let u = 1732584193, a = 4023233417, c = 2562383102, o = 271733878;
  ...
  for (; C < e.length; ) {
    ...
    u = u + k | 0, a = a + w | 0, c = c + _ | 0, o = o + E | 0, C += 16;
  }
  return [u, a, c, o].map((b) => {
...
function dt() {
  if (st) return R;
  st = 1, Object.defineProperty(R, "__esModule", { value: !0 }), R.anumber = t, R.number = t, R.abytes = r, R.bytes = r, R.ahash = u, R.aexists = a, R.aoutput = c;
  function t(s) {
...
function Ct() {
  ...
  const t = /* @__PURE__ */ dt(), e = /* @__PURE__ */ Bt(), r = /* @__PURE__ */ Ht(), u = [], a = [], c = [], o = /* @__PURE__ */ BigInt(0), s = /* @__PURE__ */ BigInt(1), y = /* @__PURE__ */ BigInt(2), S = /* @__PURE__ */ BigInt(7), v = /* @__PURE__ */ BigInt(256), P = /* @__PURE__ */ BigInt(113);
  for (let d = 0, h = s, g = 1, T = 0; d < 24; d++) {
    [g, T] = [T, (2 * g + 3 * T) % 5], u.push(2 * (5 * T + g)), a.push((d + 1) * (d + 2) / 2 % 64);
    let A = o;
    for (let l = 0; l < 7; l++)
  ...
  function k(d, h = 24) {
    ...
    for (let T = 24 - h; T < 24; T++) {
      ...
      let A = d[2], l = d[3];
      for (let i = 0; i < 24; i++) {
        const n = a[i], f = O(A, l, n), m = b(A, l, n), L = u[i];
...
function vt() {
  ...
  const c = (O = "") => a(t(O)).toString(36).slice(1), o = Array.from(
    { length: 26 },
...
const Q = /* @__PURE__ */ new Map(), Z = {
  ...
  get({
    ...
    switch (u) {
      case "memory":
        ...
        break;
      case "uni":
        s = uni.getStorageSync(c), o = s ? JSON.parse(s) : null;
        break;
      case "session":
        s = sessionStorage.getItem(c), o = s ? JSON.parse(s) : null;
        break;
      case "local":
        s = localStorage.getItem(c), o = s ? JSON.parse(s) : null;
        break;
    }
    return o && (!o.expireAt || o.expireAt > Date.now()) ? o.data : (Z.remove({ key: t, params: e, storage: u }), null);
  },
  /**
   * 从指定的存储位置清除缓存数据
   * @param {Object} options - 获取缓存的配置选项
  ...
  if (r.statusCode >= 200 && r.statusCode < 400) {
    ...
    if (a.status === V.SUCCESS) {
      const c = a.data;
      t.method === "POST" && e.fieldMap && c && Tt(e.fieldMap, c), e.after && e.after.call(e, a, t), u.Result = a;
    } else
      console.error(a), u.Error = {
        status: a.status,
        errno: a.errno,
        msg: a.msg || "请求发生错误"
      }, u.Result = a;
